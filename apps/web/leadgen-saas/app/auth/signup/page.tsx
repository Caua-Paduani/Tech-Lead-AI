...
import { Heart, Mail, Lock, User, Building, Github } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="glass-card border-white/10">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-white font-display">{t("auth.signUp.title")}</CardTitle>
            <CardDescription className="text-muted-1">{t("auth.signUp.subtitle")}</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <User className="absolute left-3 top-3 h-4 w-4 text-muted-1" />
                  <Input
                    id="fullName"
                    name="fullName"
                    type="text"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Building className="absolute left-3 top-3 h-4 w-4 text-muted-1" />
                  <Input
                    id="company"
                    name="company"
                    type="text"
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="terms" className="text-sm text-muted-1">
                  {t("auth.signUp.terms")}
                </Label>
              </div>
              ...
              <Button
                ...
                disabled={loading}
              >
                {loading ? "Creating account..." : t("auth.signUp.createAccount")}
              </Button>
            </form>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-surface-1 text-muted-1">{t("auth.signUp.orContinueWith")}</span>
                </div>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-muted-1">
                ...
                <Link href="/auth/login" className="text-brand-red hover:text-brand-red-hover transition-colors">
